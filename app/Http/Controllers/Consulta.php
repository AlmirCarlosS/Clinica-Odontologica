...
$contador = 0;
  ...
  $id=$t->id;
    	return view('usuario.prontuario.anamnese.anamnese',array('t'=>$t,'id'=>$id,'name'=>$name,
            'avatar'=>$avatar,'criado_em'=>$criado_em,'profissao'=>$profissao,'convenio'=>$convenio,
            'escolaridade'=>$escolaridade,'idade'=>$idade2,'nascimento'=>$nascimentoData,'matricula'=>$matricula,
            'contador'=>$contador));//
    }
